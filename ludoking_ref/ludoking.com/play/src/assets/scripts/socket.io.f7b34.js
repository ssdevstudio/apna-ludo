! function(t, e) {
    ...
    return function(t) {
        ...
        function r(t) {
            ...
            if ((p === e || !p) && setTimeout) return p = setTimeout, setTimeout(t, 0);
            try {
                return p(t, 0)
            } catch (n) {
                try {
        ...
        ! function() {
            try {
                p = "function" == typeof setTimeout ? setTimeout : e
            } catch (t) {
                p = e
            }
            try {
        ...
        h.nextTick = function(t) {
            ...
            l.push(new a(t, e)), 1 !== l.length || d || r(s)
        }, a.prototype.run = function() {
            this.fun.apply(null, this.array)
        }, h.title = "browser", h.browser = !0, h.env = {}, h.argv = [], h.version = "", h.versions = {}, h.on = c, h.addListener = c, h.once = c, h.off = c, h.removeListener = c, h.removeAllListeners = c, h.emit = c, h.prependListener = c, h.prependOnceListener = c, h.listeners = function() {
            return []
        }, h.binding = function() {
        ...
        function n(t) {
            return t >= c ? Math.round(t / c) + "d" : t >= a ? Math.round(t / a) + "h" : t >= s ? Math.round(t / s) + "m" : t >= i ? Math.round(t / i) + "s" : t + "ms"
        }

        function r(t) {
            return o(t, c, "day") || o(t, a, "hour") || o(t, s, "minute") || o(t, i, "second") || t + " ms"
        }
        ...
        t.exports = function(t, o) {
            o = o || {};
            var i = typeof t;
            if ("string" === i && t.length > 0) return e(t);
            if ("number" === i && !1 === isNaN(t)) return o.long ? r(t) : n(t);
        ...
        function c(t) {
            ...
            if ("/" === t.charAt(n + 1))
                for (r.nsp = ""; ++n && "," !== (s = t.charAt(n)) && (r.nsp += s, n !== t.length););
            else r.nsp = "/";
            var i = t.charAt(n + 1);
            if ("" !== i && Number(i) == i) {
                for (r.id = ""; ++n;) {
        ...
        r.prototype.encode = function(t, n) {
            f("encoding packet %j", t), e.BINARY_EVENT === t.type || e.BINARY_ACK === t.type ? s(t, n) : n([o(t)])
        ...
        (function(t) {
            ...
            e.deconstructPacket = function(t) {
                ...
                (function t(o, a, u) {
                    if (!o) return o;
                    if (c && o instanceof Blob || p && o instanceof File) {
                        n++;
                        var h = new FileReader;
                        h.onload = function() {
                            u ? u[a] = this.result : r = this.result, --n || e(r)
                        }, h.readAsArrayBuffer(o)
                    } else if (i(o))
                        for (var f = 0; f < o.length; f++) t(o[f], f, o);
                    else if ("object" == typeof o && !s(o))
        ...
        t.exports = r, r.prototype.emitAll = function() {
            ...
            var r = p(e, "open", function() {
                    n.onopen(), t && t()
                }),
                o = p(e, "error", function(e) {
            ...
            if (!1 !== this._timeout) {
                ...
                var a = setTimeout(function() {
                    h("connect attempt timed out after %d", s), r.destroy(), e.close(), e.emit("error", "timeout"), n.emitAll("connect_timeout", s)
                }, s);
                this.subs.push({
                    destroy: function() {
                        clearTimeout(a)
        ...
        (function(e) {
            ...
            t.exports = r, r.priorWebsocketSuccess = !1, s(r.prototype), r.protocol = p.protocol, r.Socket = r, r.Transport = n(20), r.transports = n(15), r.parser = n(21), r.prototype.createTransport = function(t) {
                ...
                "opening" !== this.readyState && "open" !== this.readyState && "closing" !== this.readyState || (a('socket close with reason: "%s"', t), clearTimeout(this.pingIntervalTimer), clearTimeout(this.pingTimeoutTimer), this.transport.removeAllListeners("close"), this.transport.close(), this.transport.removeAllListeners(), this.readyState = "closed", this.id = null, this.emit("close", t, e), this.writeBuffer = [], this.prevBufferLen = 0)
            ...
            e.polling = function(e) {
                ...
                if (t.location) {
                    var c = "https:" === location.protocol,
                        p = location.port;
                    p || (p = c ? 443 : 80), n = e.hostname !== location.hostname || p !== e.port, s = e.secure !== c
                }
                ...
                try {
                    ...
                    try {
                        if (this.extraHeaders)
                            for (var o in n.setDisableHeaderCheck && n.setDisableHeaderCheck(!0), this.extraHeaders) this.extraHeaders.hasOwnProperty(o) && n.setRequestHeader(o, this.extraHeaders[o])
                    } catch (s) {}
        ...
        a(r, o), r.prototype.name = "polling", r.prototype.doOpen = function() {
            ...
            var e = this;
            p("polling got data %s", t), s.decodePayload(t, this.socket.binaryType, function(t) {
        ...
        (function(t) {
            ...
            function s(t, n, r) {
                ...
                return o[0] = v[t.type], r(new k([o.buffer, t.data]))
            }
            ...
            e.encodePacket = function(e, n, i, a) {
                ...
                try {
                    ...
                    o = String.fromCharCode.apply(null, p)
                }
                ...
                var i = h(t);
                return n && i ? k && !g ? e.encodePayloadAsBlob(t, r) : e.encodePayloadAsArrayBuffer(t, r) : t.length ? void c(t, function(t, r) {
                ...
                var o;
                if ("function" == typeof n && (r = n, n = null), "" === t) return r(w, 0, 1);
                for (var i, s, a = "", c = 0, p = t.length; c < p; c++) {
                    var u = t.charAt(c);
                    if (":" === u) {
                        if ("" === a || a != (i = Number(a))) return r(w, 0, 1);
                        if (a != (s = t.substr(c + 1, i)).length) return r(w, 0, 1);
                        if (s.length) {
                ...
                return t.length ? void c(t, function(t, n) {
                ...
                c(t, function(t, n) {
                    e.encodePacket(t, !0, !0, function(t) {
                        ...
                        if (s[i.length] = 255, k) {
                            var a = new k([e.buffer, s.buffer, t]);
                            n(null, a)
                        }
                    })
                }, function(t, e) {
                ...
                for (var o = t, i = []; o.byteLength > 0;) {
                    ...
                    if (a) try {
                        ...
                        for (u = "", p = 0; p < l.length; p++) u += String.fromCharCode(l[p])
                    }
                    i.push(u), o = f(o, c)
                }
                var d = i.length;
        ...
        (function(e) {
            ...
            t.exports = function t(n) {
                ...
                if ("function" == typeof e.Buffer && e.Buffer.isBuffer && e.Buffer.isBuffer(n) || "function" == typeof e.ArrayBuffer && n instanceof ArrayBuffer || i && n instanceof Blob || s && n instanceof File) return !0;
        ...
        t.exports = function(t, n, r) {
            ...
            var i = !1;
            return r = r || e, o.count = t, 0 === t ? n() : o
        }
    }, function(t, e, n) {
        var r;
        (function(t, o) {
            ! function() {
                ...
                function h(t) {
                    ...
                    if (192 == (224 & e)) {
                        if ((n = (31 & e) << 6 | u()) >= 128) return n;
                        throw Error("Invalid continuation byte")
                    }
                    if (224 == (240 & e)) {
                        if ((n = (15 & e) << 12 | u() << 6 | u()) >= 2048) return a(n, t) ? n : 65533;
                        throw Error("Invalid continuation byte")
                    }
                    if (240 == (248 & e) && (n = (7 & e) << 18 | u() << 12 | u() << 6 | u()) >= 65536 && n <= 1114111) return n;
                    throw Error("Invalid UTF-8 detected")
                }
                var f = ("object" == typeof t && t && t.exports, "object" == typeof o && o);
                f.global !== f && f.window;
                var l, d, y, m = String.fromCharCode,
                    g = {
                        version: "2.1.2",
                        encode: function(t, e) {
                            for (var n = !1 !== (e = e || {}).strict, r = i(t), o = r.length, s = -1, a = ""; ++s < o;) a += p(r[s], n);
                            return a
                        },
                        decode: function(t, e) {
                            var n = !1 !== (e = e || {}).strict;
                            l = i(t), d = l.length, y = 0;
        ...
        function n() {
            var t = e(+new Date);
            return t !== r ? (a = 0, r = t) : t + "." + e(a++)
        }
        for (var r, o = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split(""), i = 64, s = {}, a = 0, c = 0; c < i; c++) s[o[c]] = c;
        n.encode = e, n.decode = function(t) {
            var e = 0;
        ...
        (function(e) {
            function r(t) {
                t && t.forceBase64 && (this.supportsBinary = !1), this.perMessageDeflate = t.perMessageDeflate, this.usingBrowserWebSocket = h && !t.forceNode, this.protocols = t.protocols, this.usingBrowserWebSocket || (f = o), i.call(this, t)
            }
            var o, i = n(20),
                s = n(21),
                a = n(30),
            ...
            var f = h;
            f || "undefined" != typeof window || (f = o), t.exports = r, c(r, i), r.prototype.name = "websocket", r.prototype.supportsBinary = !0, r.prototype.doOpen = function() {
                if (this.check()) {
                    var t = this.uri(),
                        e = this.protocols,
                        n = {
                ...
                for (var r = t.length, o = 0, i = r; o < i; o++) ! function(t) {
                    s.encodePacket(t, n.supportsBinary, function(o) {
                        if (!n.usingBrowserWebSocket) {
                            var i = {};
                            t.options && (i.compress = t.options.compress), n.perMessageDeflate && ("string" == typeof o ? e.Buffer.byteLength(o) : o.length) < n.perMessageDeflate.threshold && (i.compress = !1)
                        }
                        try {
                ...
                var t = this.query || {},
                    ...
                    n = "";
                return this.port && ("wss" === e && 443 !== Number(this.port) || "ws" === e && 80 !== Number(this.port)) && (n = ":" + this.port), this.timestampRequests && (t[this.timestampParam] = p()), this.supportsBinary || (t.b64 = 1), (t = a.encode(t)).length && (t = "?" + t), e + "://" + (-1 !== this.hostname.indexOf(":") ? "[" + this.hostname + "]" : this.hostname) + n + this.path + t
